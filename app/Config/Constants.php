...
//Attribute Constants
define('ATRRIBUTE_TYPE_UNDEFINED', 0);
define('ATRRIBUTE_TYPE_INETEGER', 1);

define('ATRRIBUTE_STORAGE_UNDEFINED', 0);
define('ATRRIBUTE_STORAGE_ELASTICSEARCH', 1);
define('ATRRIBUTE_STORAGE_NEO4J', 2);
